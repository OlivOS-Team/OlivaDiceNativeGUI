...
class ConfigUI(object):
    ...
    def init_hash_Combobox(self):
        ...
        self.UIObject['hash_Combobox_root'] = ttk.Combobox(
            self.UIObject['root'], textvariable=self.UIData['hash_Combobox_root_StringVar']
        )
        ...
        self.UIObject['onlineStatus_Label_root'] = tkinter.Label(
            self.UIObject['root'], textvariable=self.UIData['onlineStatus_Label_root_StringVar']
        )
        ...
        self.UIObject['onlineStatus_Label_root'].grid(
            row=0, column=1, sticky='nse', rowspan=1, columnspan=1, padx=(0, 15), pady=(15, 0), ipadx=0, ipady=0
        )
    ...
    def init_notebook(self):
        ...
        self.UIObject['Notebook_root'].grid(
            row=1, column=0, sticky='nsew', rowspan=1, columnspan=2, padx=(15, 15), pady=(8, 15), ipadx=0, ipady=0
        )
    ...
    def init_frame_main(self):
        ...
        self.UIObject['frame_main_root'].grid(
            row=1, column=0, sticky='nsew', rowspan=1, columnspan=1, padx=(0, 0), pady=(0, 0), ipadx=0, ipady=0
        )
        ...
        self.UIObject['label_master_token'] = tkinter.Label(
            self.UIObject['frame_main_root'], text='点击以下按钮复制指令，并在聊天窗口中发送给骰子，即可成为骰主！'
        )
        self.UIObject['label_master_token'].configure(
            bg=self.UIConfig['color_001'], fg=self.UIConfig['color_004'], font=('等线', 18, 'bold')
        )
        self.UIObject['label_master_token'].grid(
            row=0, column=0, sticky='nwe', rowspan=1, columnspan=9, padx=(0, 0), pady=(15, 0), ipadx=0, ipady=0
        )
        ...
        self.UIObject['buttom_master_token_copy'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_master_token_copy', '<Enter>')
        )
        self.UIObject['buttom_master_token_copy'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_master_token_copy', '<Leave>')
        )
        self.UIObject['buttom_master_token_copy'].grid(
            row=1, column=0, sticky='nwe', rowspan=1, columnspan=9, padx=(60, 60), pady=(15, 8), ipadx=0, ipady=0
        )
        ...
        try:
            self.UIObject['icon_img_data'] = self.UIObject['icon_img_data'].resize(
                (192 * 2, 108 * 2), Image.Resampling.LANCZOS if hasattr(Image, 'Resampling') else Image.LANCZOS
            )
        ...
        self.UIObject['icon_label'].configure(bg=self.UIConfig['color_001'])
        self.UIObject['icon_label'].grid(
            row=2, column=0, sticky='nwe', rowspan=1, columnspan=9, padx=(15, 15), pady=(0, 0), ipadx=0, ipady=0
        )
        ...
        self.UIObject['label_bot_info'].configure(
            bg=self.UIConfig['color_001'], fg=self.UIConfig['color_004'], font=('等线', 14, 'bold')
        )
        self.UIObject['label_bot_info'].grid(
            row=3, column=0, sticky='nwe', rowspan=1, columnspan=9, padx=(0, 0), pady=(15, 0), ipadx=0, ipady=0
        )
        ...
        self.UIObject['buttom_share_1'].grid(
            row=4, column=0, sticky='nwe', rowspan=1, columnspan=2, padx=(15, 0), pady=(15, 0), ipadx=0, ipady=0
        )
        ...
        self.UIObject['buttom_share_2'].grid(
            row=4, column=2, sticky='nwe', rowspan=1, columnspan=2, padx=(15, 0), pady=(15, 0), ipadx=0, ipady=0
        )
        ...
        self.UIObject['buttom_share_3'].grid(
            row=4, column=5, sticky='nwe', rowspan=1, columnspan=2, padx=(15, 0), pady=(15, 0), ipadx=0, ipady=0
        )
        ...
        self.UIObject['buttom_share_4'].grid(
            row=4, column=7, sticky='nwe', rowspan=1, columnspan=2, padx=(15, 0), pady=(15, 0), ipadx=0, ipady=0
        )
    ...
    def process_msg(self):
        ...
        self.UIData['buttom_master_token_copy_StringVar'].set(
            '.master %s' % OlivaDiceCore.data.bot_content['masterKey']
        )
    ...
    def init_frame_str(self):
        ...
        self.UIObject['tree_str_yscroll'] = ttk.Scrollbar(
            self.UIObject['frame_str_root'], orient='vertical', command=self.UIObject['tree_str'].yview
        )
        self.UIObject['tree_str'].configure(yscrollcommand=self.UIObject['tree_str_yscroll'].set)
        self.UIObject['tree_str_yscroll'].grid(
            row=1, column=1, sticky='nsw', rowspan=1, columnspan=1, padx=(0, 0), pady=(0, 0), ipadx=0, ipady=0
        )
        ...
        self.UIObject['button_frame_str'].grid(
            row=2, column=0, sticky='nsew', rowspan=1, columnspan=2, padx=(15, 15), pady=(8, 0)
        )
        ...
        self.UIObject['buttom_config_restore'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_config_restore', '<Enter>')
        )
        self.UIObject['buttom_config_restore'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_config_restore', '<Leave>')
        )
        ...
        self.UIObject['buttom_refresh_str'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_refresh_str', '<Enter>')
        )
        self.UIObject['buttom_refresh_str'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_refresh_str', '<Leave>')
        )
        ...
        self.UIObject['buttom_reset_delete_str'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_reset_delete_str', '<Enter>')
        )
        self.UIObject['buttom_reset_delete_str'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_reset_delete_str', '<Leave>')
        )
    ...
    def init_frame_console(self):
        ...
        self.UIObject['tree_console_yscroll'] = ttk.Scrollbar(
            self.UIObject['frame_console_root'], orient='vertical', command=self.UIObject['tree_console'].yview
        )
        self.UIObject['tree_console'].configure(yscrollcommand=self.UIObject['tree_console_yscroll'].set)
        ...
        self.UIObject['buttom_reset_console'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_reset_console', '<Enter>')
        )
        self.UIObject['buttom_reset_console'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_reset_console', '<Leave>')
        )
        ...
        self.UIObject['buttom_import_console'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_import_console', '<Enter>')
        )
        self.UIObject['buttom_import_console'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_import_console', '<Leave>')
        )
        ...
        self.UIObject['buttom_export_console'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_export_console', '<Enter>')
        )
        self.UIObject['buttom_export_console'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_export_console', '<Leave>')
        )
        ...
        self.UIObject['buttom_refresh_console'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_refresh_console', '<Enter>')
        )
        self.UIObject['buttom_refresh_console'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_refresh_console', '<Leave>')
        )
        ...
        self.UIObject['buttom_edit_console'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_edit_console', '<Enter>')
        )
        self.UIObject['buttom_edit_console'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_edit_console', '<Leave>')
        )
        ...
        self.UIObject['buttom_reset_delete_console'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_reset_delete_console', '<Enter>')
        )
        self.UIObject['buttom_reset_delete_console'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_reset_delete_console', '<Leave>')
        )
    ...
    def init_frame_backup(self):
        ...
        self.UIObject['tree_backup_yscroll'] = ttk.Scrollbar(
            self.UIObject['frame_backup_root'], orient='vertical', command=self.UIObject['tree_backup'].yview
        )
        self.UIObject['tree_backup'].configure(yscrollcommand=self.UIObject['tree_backup_yscroll'].set)
        ...
        self.UIObject['buttom_reset_backup'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_reset_backup', '<Enter>')
        )
        self.UIObject['buttom_reset_backup'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_reset_backup', '<Leave>')
        )
        ...
        self.UIObject['buttom_import_backup'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_import_backup', '<Enter>')
        )
        self.UIObject['buttom_import_backup'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_import_backup', '<Leave>')
        )
        ...
        self.UIObject['buttom_export_backup'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_export_backup', '<Enter>')
        )
        self.UIObject['buttom_export_backup'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_export_backup', '<Leave>')
        )
        ...
        self.UIObject['buttom_refresh_backup'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_refresh_backup', '<Enter>')
        )
        self.UIObject['buttom_refresh_backup'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_refresh_backup', '<Leave>')
        )
        ...
        self.UIObject['buttom_edit_backup'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_edit_backup', '<Enter>')
        )
        self.UIObject['buttom_edit_backup'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_edit_backup', '<Leave>')
        )
        ...
        self.UIObject['buttom_reset_delete_backup'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_reset_delete_backup', '<Enter>')
        )
        self.UIObject['buttom_reset_delete_backup'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_reset_delete_backup', '<Leave>')
        )
    ...
    def init_frame_account(self):
        ...
        self.UIObject['label_account_info'].grid(row=0, column=0, sticky='nsew', padx=(15, 15), pady=(15, 5))
        ...
        self.UIObject['frame_account_relation'].grid(row=1, column=0, sticky='nsew', padx=(15, 15), pady=(5, 5))
        ...
        self.UIObject['combo_master_account'] = ttk.Combobox(
            self.UIObject['frame_account_relation'], textvariable=self.UIData['account_master_StringVar'], width=20
        )
        ...
        self.UIObject['button_link_account'].bind(
            '<Enter>', lambda x: self.buttom_action('button_link_account', '<Enter>')
        )
        self.UIObject['button_link_account'].bind(
            '<Leave>', lambda x: self.buttom_action('button_link_account', '<Leave>')
        )
        ...
        self.UIObject['button_unlink_account'].bind(
            '<Enter>', lambda x: self.buttom_action('button_unlink_account', '<Enter>')
        )
        self.UIObject['button_unlink_account'].bind(
            '<Leave>', lambda x: self.buttom_action('button_unlink_account', '<Leave>')
        )
        ...
        self.UIObject['tree_account'].grid(
            row=2, column=0, sticky='nsew', rowspan=1, columnspan=1, padx=(15, 0), pady=(5, 0), ipadx=0, ipady=0
        )
        self.UIObject['tree_account_yscroll'] = ttk.Scrollbar(
            self.UIObject['frame_account_root'], orient='vertical', command=self.UIObject['tree_account'].yview
        )
        self.UIObject['tree_account'].configure(yscrollcommand=self.UIObject['tree_account_yscroll'].set)
        self.UIObject['tree_account_yscroll'].grid(
            row=2, column=1, sticky='nsw', rowspan=1, columnspan=1, padx=(0, 15), pady=(5, 0), ipadx=0, ipady=0
        )
        ...
        self.UIObject['button_frame_account'].grid(
            row=3, column=0, sticky='nsew', rowspan=1, columnspan=2, padx=(15, 15), pady=(8, 15)
        )
        ...
        self.UIObject['button_refresh_account'].bind(
            '<Enter>', lambda x: self.buttom_action('button_refresh_account', '<Enter>')
        )
        self.UIObject['button_refresh_account'].bind(
            '<Leave>', lambda x: self.buttom_action('button_refresh_account', '<Leave>')
        )
        ...
        self.UIObject['button_copy_to_account'].bind(
            '<Enter>', lambda x: self.buttom_action('button_copy_to_account', '<Enter>')
        )
        self.UIObject['button_copy_to_account'].bind(
            '<Leave>', lambda x: self.buttom_action('button_copy_to_account', '<Leave>')
        )
        ...
        self.UIObject['button_export_to_zip'].bind(
            '<Enter>', lambda x: self.buttom_action('button_export_to_zip', '<Enter>')
        )
        self.UIObject['button_export_to_zip'].bind(
            '<Leave>', lambda x: self.buttom_action('button_export_to_zip', '<Leave>')
        )
        ...
        self.UIObject['button_import_from_zip'].bind(
            '<Enter>', lambda x: self.buttom_action('button_import_from_zip', '<Enter>')
        )
        self.UIObject['button_import_from_zip'].bind(
            '<Leave>', lambda x: self.buttom_action('button_import_from_zip', '<Leave>')
        )
    ...
    def unlink_account(self):
        ...
        try:
            ...
            if selected_slaves:
                ...
                accounts_to_unlink = [
                    (hash, name, id, display_name, []) for hash, name, id, display_name in selected_masters
                ]
                account_type = '主账号'
            # 显示确认对话框
            if len(accounts_to_unlink) == 1:
                ...
                if master_list:
                    # 从账号（只会有一个主账号）
                    if not messagebox.askyesno('确认', f'确定要断开账号 {display_name} 与其主账号的关系吗？'):
                        return
                else:
                ...
                account_names = '\n'.join([
                    f'  - {display_name}' for hash, name, id, display_name, _ in accounts_to_unlink
                ])
                if not messagebox.askyesno(
                    '确认',
            ...
            for bot_hash, bot_name, bot_id, display_name, master_list in accounts_to_unlink:
                try:
                    success, result = OlivaDiceMaster.accountManager.unlinkAccount(
                        bot_hash, bot_info_dict=OlivaDiceNativeGUI.load.dictBotInfo
                    )
                    if success:
                        success_count += 1
                    else:
    ...
    def export_to_zip(self):
        ...
        try:
            ...
            if len(account_list) == 1:
                ...
                # 多个账号导出
                # 选择保存目录
                export_dir = filedialog.askdirectory(title='选择导出目录', initialdir='./plugin/export')
                ...
                for bot_hash, bot_name, bot_id in account_list:
                    try:
                        ...
                        if success:
                            ...
                            display_name = (
                                f'{bot_name} ({bot_id})' if bot_id != '-' else f'{bot_name} ({bot_hash[:8]}...)'
                            )
                            failed_list.append(f'{display_name}: {result}')
                    except Exception as e:
                        display_name = f'{bot_name} ({bot_id})' if bot_id != '-' else f'{bot_name} ({bot_hash[:8]}...)'
                ...
                if success_count == len(account_list):
                    ...
                    result_msg = (
                        f'部分成功：{success_count}/{len(account_list)} 个账号导出成功\n\n导出目录: {export_dir}\n\n'
                    )
                    if failed_list:
                        result_msg += '失败的账号:\n' + '\n'.join(failed_list)
                    messagebox.showwarning('部分成功', result_msg)
    ...
    def import_from_zip(self):
        ...
        try:
            ...
            entry_source_hash = tkinter.Entry(
                frame_source_hash, textvariable=source_hash_var, width=45, font=('等线', 9)
            )
            ...
            def do_import():
                ...
                try:
                    success, result, auto_hash = OlivaDiceMaster.accountManager.importAccountDataFromZip(
                        zip_path,
                        target_bot_hash,
                        OlivaDiceNativeGUI.load.globalProc,
                        overwrite=False,
                        sourceBotHash=source_hash,
                    )
    ...
    def init_frame_master(self):
        ...
        self.UIObject['tree_master'].grid(
            row=0, column=6, sticky='nsew', rowspan=4, columnspan=1, padx=(0, 0), pady=(0, 0), ipadx=0, ipady=0
        )
        self.UIObject['tree_rightkey_menu'] = tkinter.Menu(self.UIObject['root'], tearoff=False)
        ...
        self.UIObject['tree_master_yscroll'] = ttk.Scrollbar(
            self.UIObject['frame_master_root'], orient='vertical', command=self.UIObject['tree_master'].yview
        )
        self.UIObject['tree_master'].configure(yscrollcommand=self.UIObject['tree_master_yscroll'].set)
        self.UIObject['tree_master_yscroll'].grid(
            row=0, column=7, sticky='nsw', rowspan=4, columnspan=1, padx=(0, 0), pady=(0, 0), ipadx=0, ipady=0
        )

        self.UIData['entry_master_StringVar'] = tkinter.StringVar()
        self.UIObject['entry_master'] = tkinter.Entry(
            self.UIObject['frame_master_root'], textvariable=self.UIData['entry_master_StringVar']
        )
        ...
        self.UIObject['entry_master'].grid(
            row=0, column=1, sticky='nwe', rowspan=1, columnspan=3, padx=(0, 0), pady=(180, 0), ipadx=4, ipady=8
        )
        ...
        self.UIObject['buttom_master_add'].grid(
            row=1, column=1, sticky='new', rowspan=1, columnspan=1, padx=(0, 0), pady=(45, 0), ipadx=0, ipady=0
        )
        ...
        self.UIObject['buttom_master_del'].grid(
            row=1, column=3, sticky='new', rowspan=1, columnspan=1, padx=(0, 0), pady=(45, 0), ipadx=0, ipady=0
        )
    ...
    def init_frame_deck(self):
        ...
        self.UIObject['label_deck_local_note'] = tkinter.Label(self.UIObject['frame_deck_root'], text='本地牌堆')
        self.UIObject['label_deck_local_note'].configure(
            bg=self.UIConfig['color_001'], fg=self.UIConfig['color_004'], font=('等线', 12)
        )
        self.UIObject['label_deck_local_note'].grid(
            row=0, column=0, sticky='nw', rowspan=1, columnspan=9, padx=(0, 0), pady=(10, 5), ipadx=0, ipady=0
        )
        ...
        self.UIObject['tree_deck_local_yscroll'] = ttk.Scrollbar(
            self.UIObject['frame_deck_root'], orient='vertical', command=self.UIObject['tree_deck_local'].yview
        )
        self.UIObject['tree_deck_local'].configure(yscrollcommand=self.UIObject['tree_deck_local_yscroll'].set)
        ...
        self.UIObject['buttom_deck_reload'].configure(font=('等线', 12))
        self.UIObject['buttom_deck_reload'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_deck_reload', '<Enter>')
        )
        self.UIObject['buttom_deck_reload'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_deck_reload', '<Leave>')
        )
        self.UIObject['buttom_deck_reload'].grid(
            row=1, column=2, sticky='new', rowspan=1, columnspan=3, padx=(15, 15), pady=(0, 2), ipadx=0, ipady=0
        )
        ...
        self.UIObject['buttom_deck_remove'].configure(font=('等线', 12))
        self.UIObject['buttom_deck_remove'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_deck_remove', '<Enter>')
        )
        self.UIObject['buttom_deck_remove'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_deck_remove', '<Leave>')
        )
        self.UIObject['buttom_deck_remove'].grid(
            row=2, column=2, sticky='new', rowspan=1, columnspan=1, padx=(15, 2), pady=(2, 2), ipadx=0, ipady=0
        )
        ...
        self.UIObject['buttom_deck_dir_unity'].configure(font=('等线', 12))
        self.UIObject['buttom_deck_dir_unity'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_deck_dir_unity', '<Enter>')
        )
        self.UIObject['buttom_deck_dir_unity'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_deck_dir_unity', '<Leave>')
        )
        self.UIObject['buttom_deck_dir_unity'].grid(
            row=5, column=2, sticky='new', rowspan=1, columnspan=1, padx=(15, 2), pady=(60, 2), ipadx=0, ipady=0
        )
        ...
        self.UIObject['buttom_deck_dir_this'].configure(font=('等线', 12))
        self.UIObject['buttom_deck_dir_this'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_deck_dir_this', '<Enter>')
        )
        self.UIObject['buttom_deck_dir_this'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_deck_dir_this', '<Leave>')
        )
        self.UIObject['buttom_deck_dir_this'].grid(
            row=6, column=2, sticky='new', rowspan=1, columnspan=1, padx=(15, 2), pady=(2, 2), ipadx=0, ipady=0
        )
        ...
        self.UIObject['buttom_deck_install_unity'].configure(font=('等线', 12))
        self.UIObject['buttom_deck_install_unity'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_deck_install_unity', '<Enter>')
        )
        self.UIObject['buttom_deck_install_unity'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_deck_install_unity', '<Leave>')
        )
        self.UIObject['buttom_deck_install_unity'].grid(
            row=2, column=4, sticky='new', rowspan=1, columnspan=1, padx=(2, 15), pady=(2, 2), ipadx=0, ipady=0
        )
        ...
        self.UIObject['buttom_deck_install_this'].configure(font=('等线', 12))
        self.UIObject['buttom_deck_install_this'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_deck_install_this', '<Enter>')
        )
        self.UIObject['buttom_deck_install_this'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_deck_install_this', '<Leave>')
        )
        self.UIObject['buttom_deck_install_this'].grid(
            row=3, column=4, sticky='new', rowspan=1, columnspan=1, padx=(2, 15), pady=(2, 2), ipadx=0, ipady=0
        )
        ...
        self.UIObject['buttom_deck_upload'].configure(font=('等线', 12))
        self.UIObject['buttom_deck_upload'].bind(
            '<Enter>', lambda x: self.buttom_action('buttom_deck_upload', '<Enter>')
        )
        self.UIObject['buttom_deck_upload'].bind(
            '<Leave>', lambda x: self.buttom_action('buttom_deck_upload', '<Leave>')
        )
        self.UIObject['buttom_deck_upload'].grid(
            row=6, column=4, sticky='new', rowspan=1, columnspan=1, padx=(2, 15), pady=(2, 2), ipadx=0, ipady=0
        )

        self.UIObject['label_deck_remote_note'] = tkinter.Label(
            self.UIObject['frame_deck_root'], textvariable=self.UIData['label_deck_remote_note_StringVar']
        )
        ...
        self.UIObject['label_deck_remote_note'].grid(
            row=0, column=5, sticky='nw', rowspan=1, columnspan=9, padx=(0, 0), pady=(10, 5), ipadx=0, ipady=0
        )
        ...
        self.UIObject['tree_deck_remote_yscroll'] = ttk.Scrollbar(
            self.UIObject['frame_deck_root'], orient='vertical', command=self.UIObject['tree_deck_remote'].yview
        )
        self.UIObject['tree_deck_remote'].configure(yscrollcommand=self.UIObject['tree_deck_remote_yscroll'].set)
        ...
        self.UIObject['label_deck_note'] = tkinter.Text(self.UIObject['frame_deck_root'], wrap=tkinter.CHAR, width=30)
        ...
        self.UIObject['label_deck_note'].grid(
            row=7, column=2, sticky='nswe', rowspan=1, columnspan=3, padx=(15, 15), pady=(20, 0), ipadx=0, ipady=0
        )
                ...
                for deck_this in tmp_dataList[deck_type_this]:
                    if (
                        ...
                        tmp_text = '%s\n\n%s\n作者: %s\n版本: %s(%s)\n\n%s' % (
                            str(deck_this['name']),
                            str(
                                {'classic': '青果系JSON', 'yaml': '塔系YAML', 'excel': '梨系Excel'}.get(
                                    deck_this['sub_type'], '新型'
                                )
                            )
                            + str(
                                {
    ...
    def tree_console_rightKey(self, event):
        ...
        self.UIObject['tree_rightkey_menu'].add_command(
            label='恢复/删除', command=lambda: self.reset_selected_console()
        )
        self.UIObject['tree_rightkey_menu'].post(event.x_root, event.y_root)
    ...
    def tree_str_edit(self):
        ...
        if len(tmp_key) > 0:
            self.edit_str_UI(
                root_obj=self.UIObject['root'], root_class=self, key=tmp_key, hash=self.UIData['hash_now']
            ).start()
    ...
    def edit_restore_modules(self):
        ...
        self.edit_modules_UI(
            root_obj=self.UIObject['root'], root_class=self, hash_selection=self.UIData['hash_now']
        ).start()
    ...
    def tree_master_config(self, action: str):
        ...
        if tmp_platform != None and tmp_master_target != None:
            ...
            if action == 'add':
                tmp_dataList_new = []
                tmp_dataList = OlivaDiceCore.console.getConsoleSwitchByHash('masterList', tmp_hashSelection)
                flag_done = False
                ...
                if not flag_done:
                    tmp_dataList_new.append([tmp_master_target, tmp_platform])
                    OlivaDiceCore.console.setConsoleSwitchByHash('masterList', tmp_dataList_new, tmp_hashSelection)
    ...
    class edit_str_UI(object):
        ...
        def start(self):
            ...
            self.UIObject['label_note'] = tkinter.Label(self.UIObject['root'], text=tmp_info, font=('等线', 12, 'bold'))
            ...
            self.UIObject['label_note'].grid(
                row=0, column=0, sticky='nsew', rowspan=1, columnspan=1, padx=(15, 15), pady=(15, 0), ipadx=0, ipady=0
            )
            self.UIData['entry_edit_StringVar'] = tkinter.StringVar()
            self.UIObject['entry_edit'] = tkinter.Text(self.UIObject['root'], wrap=tkinter.WORD)
            self.UIObject['entry_edit'].configure(
                bg=self.UIConfig['color_004'], fg=self.UIConfig['color_005'], bd=0, font=(None, 10), padx=4, pady=8
            )
            self.UIObject['entry_edit'].grid(
                row=1, column=0, sticky='nsew', rowspan=1, columnspan=1, padx=(15, 15), pady=(8, 15), ipadx=4, ipady=8
            )
...
6. 若不知道这里是做什么的，请不要随意修改。""",
    ...
    class edit_console_UI(object):
        ...
        def start(self):
            ...
            self.UIObject['root'].resizable(width=True, height=False)
            self.UIObject['root'].grid_rowconfigure(0, weight=0)
            self.UIObject['root'].grid_rowconfigure(1, weight=15)
            self.UIObject['root'].grid_columnconfigure(0, weight=15)
            self.UIObject['root'].configure(bg=self.UIConfig['color_001'])
            ...
            self.UIObject['entry_edit'] = tkinter.Entry(
                self.UIObject['root'], textvariable=self.UIData['entry_edit_StringVar']
            )
            self.UIObject['entry_edit'].configure(
                bg=self.UIConfig['color_006'],
                fg=self.UIConfig['color_001'],
            ...
            self.UIObject['entry_edit'].grid(
                row=1, column=0, sticky='n', rowspan=1, columnspan=1, padx=(15, 15), pady=(8, 15), ipadx=0, ipady=8
            )
    ...
    def init_data_total(self):
        ...
        buttons_to_disable_in_global = [
            'buttom_config_restore',
            'buttom_reset_str',
            'buttom_import_str',
            'buttom_export_str',
            'buttom_refresh_str',
            'buttom_reset_delete_str',
        ]
    ...
    def init_data_deck_remote(self):
        ...
        for deck_type_this in ['classic', 'yaml', 'excel']:
            if (
                ...
                for deck_this in tmp_dataList[deck_type_this]:
                    if 'name' in deck_this and 'author' in deck_this:
    ...
    def reset_console_confirm(self):
        """显示恢复默认配置的确认对话框"""
        if messagebox.askyesno(
            '确认恢复', '确定要恢复所有配置项为默认值吗？这将重置所有自定义配置。', parent=self.UIObject['root']
        ):
    ...
    def reset_selected_str(self):
        ...
        if tmp_key in default_str_dict:
            if messagebox.askyesno(
                '确认恢复', f"确定要恢复'{tmp_key}'的回复词为默认值吗？", parent=self.UIObject['root']
            ):
            ...
            if messagebox.askyesno(
                '确认删除', f"确定要删除'{tmp_key}'的自定义回复词吗？", parent=self.UIObject['root']
            ):
    ...
    def reset_selected_console(self):
        ...
        if tmp_key in default_config:
            if messagebox.askyesno(
                '确认恢复', f"确定要恢复'{tmp_key}'的配置为默认值吗？", parent=self.UIObject['root']
            ):
            ...
            if messagebox.askyesno('确认删除', f"确定要删除'{tmp_key}'的自定义配置吗？", parent=self.UIObject['root']):
    ...
    def refresh_str_config(self):
        """刷新回复词配置"""
        if messagebox.askyesno(
            '确认刷新', '确定要从文件重新加载回复词配置吗？这将覆盖当前所有修改。', parent=self.UIObject['root']
        ):
            tmp_hashSelection = self.UIData['hash_now']
            backup_data = OlivaDiceCore.msgCustom.dictStrCustomDict.get(tmp_hashSelection, {}).copy()
            backup_update = OlivaDiceCore.msgCustom.dictStrCustomUpdateDict.get(tmp_hashSelection, {}).copy()
    ...
    def refresh_console_config(self):
        """刷新控制台配置"""
        if messagebox.askyesno(
            '确认刷新', '确定要从文件重新加载控制台配置吗？这将覆盖当前所有修改。', parent=self.UIObject['root']
        ):
            tmp_hashSelection = self.UIData['hash_now']
    ...
    def refresh_backup_config(self):
        """刷新备份配置"""
        if messagebox.askyesno(
            '确认刷新', '确定要从文件重新加载备份配置吗？这将覆盖当前所有修改。', parent=self.UIObject['root']
        ):
            backup_data = OlivaDiceCore.console.dictBackupConfig.get('unity', {}).copy()
            try:
    ...
    def reset_backup_confirm(self):
        """确认重置备份配置"""
        if messagebox.askyesno(
            '确认重置', '确定要恢复所有备份配置为默认值吗？这将重置所有自定义配置。', parent=self.UIObject['root']
        ):
            try:
                # 获取默认值并重置配置
                defaults = self.get_backup_config_defaults()
    ...
    def tree_backup_rightKey(self, event):
        ...
        try:
            ...
            self.UIObject['tree_rightkey_menu_backup'].add_command(
                label='编辑', command=lambda: self.tree_backup_edit()
            )
            self.UIObject['tree_rightkey_menu_backup'].add_command(
            ...
            if tmp_key in defaults:
                ...
                if messagebox.askyesno(
                    ...
                    try:
                        ...
                        self.init_data_total()
                        messagebox.showinfo(
                            '完成', f"已恢复备份配置项 '{tmp_key}' 为默认值", parent=self.UIObject['root']
                        )
                    except Exception as e:
                ...
                # 非必需配置项，提供删除选项
                if messagebox.askyesno(
                    '确认删除', f"配置项 '{tmp_key}' 不是必需项，确定要删除吗？", parent=self.UIObject['root']
                ):
                    try:
                        if 'unity' in OlivaDiceCore.console.dictBackupConfig:
                            if tmp_key in OlivaDiceCore.console.dictBackupConfig['unity']:
                                ...
                                self.init_data_total()
                                messagebox.showinfo(
                                    '完成', f"已删除备份配置项 '{tmp_key}'", parent=self.UIObject['root']
                                )
                            else:
                                messagebox.showwarning('警告', '未找到对应的备份配置项', parent=self.UIObject['root'])
                        else:
